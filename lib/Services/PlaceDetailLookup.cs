...
namespace LockedNLoaded.Services
{
    ...
    public class PlaceDetailLookup
    {
        ...
        {
            public string TopicId = "place-process-queue";
            public string SubscriptionId = "shared-worker-subscription";
        };

        public PlaceDetailLookup(string projectId, Options options = null, ISimpleLogger logger = null)
        {
        ...
        public Task StartPullLoop(IPlaceStore bookStore, CancellationToken cancellationToken)
        {
        ...
        public static void UpdateBookFromJson(string json, Place book)
        {
