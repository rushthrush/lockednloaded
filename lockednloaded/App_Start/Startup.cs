...
[assembly: OwinStartupAttribute(typeof(LockedNLoaded.Startup))]
...
namespace LockedNLoaded
{
    public class Startup
    {
        ...
        public void Configuration(IAppBuilder app)
        {
            ...
            {
                ClientId = LibUnityConfig.GetConfigVariable("LockedNLoaded:AuthClientId"),
                ClientSecret = LibUnityConfig.GetConfigVariable("LockedNLoaded:AuthClientSecret"),
            };
